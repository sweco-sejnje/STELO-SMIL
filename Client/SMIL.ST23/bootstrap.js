...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Smile.controller.Main": [],
  "Smile.controller.MainFeatureForm": [],
  "Smile.controller.MainFeatureListTopBar": [],
  "Smile.controller.MainFeatureNotesPanel": [],
  "Smile.controller.MainFeaturePictureController": [],
  "Smile.controller.MainTopBar": [],
  "Smile.controller.MapWFSService": [],
  "Smile.controller.SmileDynamicModelMaker": [],
  "Smile.controller.SmileDynamicStoreController": [],
  "Smile.controller.SmileListController": [],
  "Smile.controller.SmileLoadMapFeatures": [],
  "Smile.controller.SmileMapFunctions": [],
  "Smile.controller.SmileMapGeolocate": [],
  "Smile.model.Capabilities": [],
  "Smile.model.FeatureNote": [],
  "Smile.model.FeaturePicture": [],
  "Smile.model.Layer": [],
  "Smile.store.Capabilities": [],
  "Smile.store.FeatureNote": [],
  "Smile.store.FeaturePicture": [],
  "Smile.view.Main": [],
  "Smile.view.MainBottomBar": [],
  ...
  "Smile.view.MainTopBar": [],
  "Smile.view.Popup": [],
  "Smile.view.PopupList": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Smile.view.MainFeatureCarousel": [
    "widget.mainfeaturecarousel"
  ],
  "Smile.view.MainFeatureEditNoteFormPanel": [
    "widget.editnoteformpanel"
  ],
  "Smile.view.MainFeatureEditPictureFormPanel": [
    "widget.editpictureformpanel"
  ],
  "Smile.view.MainFeatureForm": [
    "widget.mainfeatureformpanel"
  ],
  "Smile.view.MainFeatureListSheet": [
    "widget.mainfeaturelistsheet"
  ],
  "Smile.view.MainFeatureListSmileFeatureList": [
    "widget.smileFeatureList"
  ],
  "Smile.view.MainFeatureListTopBar": [
    "widget.mainfeaturelisttopbar"
  ],
  "Smile.view.MainFeatureNoteFormPanel": [
    "widget.noteformpanel"
  ],
  "Smile.view.MainFeatureNotesList": [
    "widget.featurenoteslist"
  ],
  "Smile.view.MainFeatureNotesPanel": [
    "widget.featurenotespanel"
  ],
  "Smile.view.MainFeaturePictureContainer": [
    "widget.featurepicturecontainer"
  ],
  "Smile.view.MainFeaturePictureFormPanel": [
    "widget.featurepictureformpanel"
  ],
  "Smile.view.MainFeaturePicturesList": [
    "widget.featurepictureslist"
  ],
  "Smile.view.MainTopBar": [
    "widget.maintopbar"
  ],
