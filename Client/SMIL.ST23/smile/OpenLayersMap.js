 ...
 *
 */
Ext.define('Ext.smile.OpenLayersMap', {
	...
	config: {
		...
		/**
		 * @cfg {String} baseLayerName
		 * Defines the name of the baslayer in the map.
		 * 
		 * @accessor
		 */
    ...
    onGeoUpdate: function(geo) {
    	...
    	this.renderCurrentLocation(geo);
    },
    ...
    // @private
    renderCurrentLocation: function(geo) {
        var me = this,
            map = this.getMap();
    	...
    	if(vector == undefined){
    		vector = new OpenLayers.Layer.Vector("Geolocation Layer", {

    		});
	    	map.addLayers([vector]);
		}

        var point = new OpenLayers.Geometry.Point(geo.getLongitude(), geo.getLatitude())
        point.transform('EPSG:4326', map.getProjection())
		    ...
		    vector.addFeatures([
		        ...
		        new OpenLayers.Feature.Vector(
		            OpenLayers.Geometry.Polygon.createRegularPolygon(
		                ...
		                geo.position.coords.accuracy / 2,
		                50,
		                0
		            ),
		            {},
