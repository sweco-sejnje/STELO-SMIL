Ext.define('Smile.controller.SmileMapGeolocate', {
    ...
    geolocate: function(component){
    	
    	var mapPanel = this.getMapPanel();
    	var map = mapPanel.getMap();
    	
    	var geoLocateLayer = map.getLayersByName('Geolocation Layer')[0];
    	
    	
    	
    	if(geoLocateLayer == undefined){
    	...
    	var geolocate = map.getControl('locate-control'); 

    	if(geolocate == undefined){
